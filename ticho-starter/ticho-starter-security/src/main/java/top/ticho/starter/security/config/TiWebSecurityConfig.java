...
public class TiWebSecurityConfig {
    ...
    @Bean
    @Order(100)
    public SecurityFilterChain filterChain(HttpSecurity http, TiAuthorizationManager tiAuthorizationManager) throws Exception {
        http
            // 禁用表单登录
            ...
            .authorizeHttpRequests(registry -> registry
                ...
                .anyRequest().access(tiAuthorizationManager)
            )
            // 显式声明禁用缓存控制
