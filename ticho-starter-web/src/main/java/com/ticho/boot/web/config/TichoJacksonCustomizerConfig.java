...
import com.ticho.boot.web.converter.CustomLocalDateDeserializer;
import com.ticho.boot.web.converter.CustomLocalDateTimeDeserializer;
 ...
 */
@Configuration
public class TichoJacksonCustomizerConfig {
