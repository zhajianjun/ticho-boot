...
public record ServerConnectListener(
    ...
    public void operationComplete(ChannelFuture future) {
        ...
        clientChannel.attr(TiIntranetConst.CHANNEL).set(this.requestChannel);
        this.requestChannel.attr(TiIntranetConst.CHANNEL).set(clientChannel);
        ...
        this.requestChannel.attr(TiIntranetConst.REQUEST_ID).set(requestId);
